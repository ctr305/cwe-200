            ...
            <div class="card mx-auto mt-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="email" name="email" required placeholder="cuenta@uv.mx">
                ...
                <div class="card-footer text-center">
                    <button type="submit" class="btn btn-primary w-100" id="submit">Siguiente</button>
                </div>
            </div>
        </form>
    </div>
